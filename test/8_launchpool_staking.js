...
contract("LaunchpoolStaking", function (accounts) {
  ...
  describe("Constructor", function () {
    ...
    it("should set correct apy", async function () {
      assert.equal(0, (await launchpoolStaking.apy.call()).cmp(new BN("500")), "Wrong apy");
    });
  });
  ...
  describe("updateAPY", function () {
    ...
    it("should set correct value", async function () {
      assert.isTrue((await launchpoolStaking.apy.call()).eq(new BN(500)), "wrong before");
  ...
  describe("stake", function () {
    ...
    it("should set Stake with correct params", async function () {
